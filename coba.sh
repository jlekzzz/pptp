...
# install webserver
cd
wget -O /etc/nginx/nginx.conf "http://script.jualssh.com/autoscript/conf/nginx.conf"
sed -i 's/www-data/nginx/g' /etc/nginx/nginx.conf
mkdir -p /home/vps/public_html
wget -O /home/vps/public_html/index.html "http://script.jualssh.com/autoscript/conf/index.html"
echo "<?php phpinfo(); ?>" > /home/vps/public_html/info.php
rm /etc/nginx/conf.d/*
wget -O /etc/nginx/conf.d/vps.conf "http://script.jualssh.com/autoscript/conf/vps.conf"
...
# install badvpn
wget -O /usr/bin/badvpn-udpgw "http://script.jualssh.com/autoscript/conf/badvpn-udpgw"
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/badvpn-udpgw "http://script.jualssh.com/autoscript/conf/badvpn-udpgw64"
fi
...
# install mrtg
cd /etc/snmp/
wget -O /etc/snmp/snmpd.conf "http://script.jualssh.com/autoscript/conf/snmpd.conf"
wget -O /root/mrtg-mem.sh "http://script.jualssh.com/autoscript/conf/mrtg-mem.sh"
...
curl "http://script.jualssh.com/autoscript/conf/mrtg.conf" >> /etc/mrtg/mrtg.cfg
...
# install squid
yum -y install squid
wget -O /etc/squid/squid.conf "http://script.jualssh.com/autoscript/conf/squid-centos.conf"
...
# install webmin
cd
wget http://script.jualssh.com/autoscript/conf/webmin-1.680-1.noarch.rpm
...
# pasang bmon
if [ "$OS" == "x86_64" ]; then
  wget -O /usr/bin/bmon "http://script.jualssh.com/autoscript/conf/bmon64"
else
  wget -O /usr/bin/bmon "http://script.jualssh.com/autoscript/conf/bmon"
fi
...
wget -O limit.sh "http://script.jualssh.com/autoscript/conf/limit.sh"
